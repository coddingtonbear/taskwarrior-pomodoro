...
class TWMenu: NSObject, NSMenuDelegate, NSUserNotificationCenterDelegate {
    ...
    var image: NSImage? = {
        #if DEBUG
        return NSImage(named: NSImage.Name(rawValue: "StatusBarButtonImageDevelopment"))
        #else
        return NSImage(named: NSImage.Name(rawValue: "StatusBarButtonImage"))
        #endif
    }()
