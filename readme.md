...
You can [download the latest release here](http://coddingtonbear-public.s3.amazonaws.com/github/taskwarrior-pomodoro/releases/taskwarrior-pomodoro-1.0.2.dmg), and install it by dragging the application into your Applications directory.
